...
ROS will expect your python installation being available in directory ``C:\python38``. You may want to cross-check it's became available there (no interference with pre-existent python install).
...
The following commands adds 'OPENSSL_CONF' to your registry. Check your (default) installation directory to be ``C:\Program Files\OpenSSL-Win64``:
